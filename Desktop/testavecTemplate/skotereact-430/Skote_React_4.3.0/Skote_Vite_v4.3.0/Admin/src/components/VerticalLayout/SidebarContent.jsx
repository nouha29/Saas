...
const SidebarContent = (props) => {
 ...
 const activeMenu = useCallback(() => {
  ...
  console.log("Current path:", pathName); // Débogage
  ...
  activeMenu();
  console.log("MetisMenu initialized, items:", document.getElementById("side-menu").getElementsByTagName("a")); // Débogage

  return () => {
    metisMenu.dispose();
    new MetisMenu("#side-menu"); // Réinitialisation
  };
}, []);
          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="/dashboard-Extraction">{props.t("Extraction")}</Link>
                </li>
              </ul>
            </li>
